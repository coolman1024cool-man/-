...
# 1. 更新 Excel 資料 (合併為 1 式)
data = {
    '品名': ['智能咖啡烘豆機周邊與驅動套件'],
    '規格': ['1. 瓦斯閥馬達驅動組 (drv 8825)\n2. 麥克風套件 (ReSpeaker Mic Array v3.0) 與延伸桿套件組\n3. 110V AC轉12V DC變壓器\n4. 落地式支架與手機夾'],
    '用途及說明': ['智能咖啡烘豆機'],
    '計量單位': ['式'],
    '數量': [1],
    '單價': [77772]
...
with open('D:/01邱正彥1130801-/01經費/ALLTOP_採購自動化工具/run_bot.py', 'w', encoding='utf-8') as f:
    f.write(bot_script)
